...
sana_res = {
    ...
    "4K": {
		'0.25': [2048, 8192], '0.26': [2048, 7936], '0.27': [2048, 7680], '0.28': [2048, 7424],
		'0.32': [2304, 7168], '0.33': [2304, 6912], '0.35': [2304, 6656], '0.40': [2560, 6400],
		'0.42': [2560, 6144], '0.48': [2816, 5888], '0.50': [2816, 5632], '0.52': [2816, 5376],
		'0.57': [3072, 5376], '0.60': [3072, 5120], '0.68': [3328, 4864], '0.72': [3328, 4608],
		'0.78': [3584, 4608], '0.82': [3584, 4352], '0.88': [3840, 4352], '0.94': [3840, 4096],
		'1.00': [4096, 4096], '1.07': [4096, 3840], '1.13': [4352, 3840], '1.21': [4352, 3584],
		'1.29': [4608, 3584], '1.38': [4608, 3328], '1.46': [4864, 3328], '1.67': [5120, 3072],
		'1.75': [5376, 3072], '2.00': [5632, 2816], '2.09': [5888, 2816], '2.40': [6144, 2560],
		'2.50': [6400, 2560], '2.89': [6656, 2304], '3.00': [6912, 2304], '3.11': [7168, 2304],
		'3.62': [7424, 2048], '3.75': [7680, 2048], '3.88': [7936, 2048], '4.00': [8192, 2048],
	}
}
...
sana_res.update({
    ...
    "SanaMS_1600M_P1_D20_4K": sana_res["4K"],
})
